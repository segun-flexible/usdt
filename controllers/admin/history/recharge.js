...
const { getAdminRechargeHistory } = require("../../../helpers/history");
const { extractTime, getDateFormatForPost } = require("../../../helpers/dateTime");


exports.adminRechargeHistoryGet = asyncHandler(async (req, res, next) => {
    ...
    const history = await getAdminRechargeHistory(limit, getNextOffset(currentPage, limit));
    ...
    //Pagination
    const pageData = await getAdminRechargeHistory(9999999999, 0);
    ...
    //Pagination Link
    link = `/admin/history/recharge?`

    res.render("admin/pages/history/recharge", {
